    ...
    <div class="single-item-list">
        <div class="row align-items-center">
            ...
            <div class="col-lg-3 col-md-3 col-12">
                ...
                <span class="btn btn-sm btn-primary" id="tombol-bukti" data-id="{{ $tugas->id }}" data-bs-toggle="modal"
                ...
                <span id="batalkan" class="btn btn-xs btn-danger" data-id="{{ $tugas->id }}">Ditolak</span>
                @endif
