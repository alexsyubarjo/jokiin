                    ...
                    <div class="dashboard-block mt-0">
                        ...
                        <div class="inner-block">
                            ...
                            <div class="post-ad-tab">
                                ...
                                <form class="default-form-style" method="post" action="{{ route('posts.store') }}"
                                                        ...
                                                        <div class="col-lg-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input id="komisi" name="komisi" type="text"
                                                                    placeholder="Komisi" value="{{ old('komisi') }}">
                                                                <small>*Minimal komisi 100</small>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label>Saldo di Butuhkan</label>
                                                                <div class="alert alert-secondary" id="total"></div>
                                                            </div>
                                                        </div>
                                                        <div class="col-12">
...
<script>
    $(document).ready(function() {
        ...
        if (jum === '' || isNaN(parseFloat(jum))) {
            $("#nav-user-info-tab").addClass("disabled");
        }

        $('#jumlah, #komisi').on('keyup', function() {
            var saldo = "{{ $user->saldo_employer }}";
            var jum = $("#jumlah").val().replace(/\./g, '');
            var kom = $("#komisi").val().replace(/\./g, '');
            var tot = jum * kom;
            ...
            $('#total').text(tot.toLocaleString());
            if (saldo < tot) {
                $("#nav-user-info-tab").addClass("disabled");
            }else{
                $("#nav-user-info-tab").removeClass("disabled");
            }
            if (kom < 100) {
                $("#nav-user-info-tab").addClass("disabled");
            }else{
