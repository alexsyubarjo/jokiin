                        ...
                        <div class="d-flex align-items-center">
                            <ul class="list-unstyled users-list m-0 avatar-group">
                                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
                                    class="avatar avatar-xs pull-up" title="{{ $d->user->name }}">
                                    <img src="{{ asset('storage/users-avatar/' . $d->user->avatar) }}" alt="Avatar"
                                        class="rounded-circle" />
                                </li>
                            </ul>
                            <strong class="ms-2">{{ $d->user->name }}</strong>
                        </div>
                    </td>
                    <td width="30%">{{ $d->post->title }}</td>
                    <td width="30%">{{ $d->comments }}</td>
                    <td>
                        <button id="data-bukti" data-id="{{ $d->id }}" type="button" class="btn btn-info btn-xs"
