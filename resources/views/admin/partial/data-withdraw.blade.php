    ...
    <div class="table-responsive" style="height: 500px;">
        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                $inal = $d->nominal * ($web->wd / 100);
                $nominal = $d->nominal - $inal;

                @endphp
                <tr>
                    <td>{{ $d->user->name }}</td>
                    <td>
                        <button id="data-rekening" data-id="{{ $d->user->id }}" type="button"
                            class="btn btn-info btn-xs" data-bs-toggle="modal" data-bs-target="#dataModal">
                            Data Rekening
                        </button>
                    </td>
                    <td class="fw-bold">Rp {{ number_format($nominal, 0, ',', '.') }}</td>
                    <td>Penarikan Dana {{ $d->created_at->format('d M Y, H:i') }}WIB</td>
                    <td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                @if (request()->segment(3) == "permintaan-withdraw")
