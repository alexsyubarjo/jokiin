    ...
    <div class="table-responsive" style="height: 500px;">
        ...
        <table class="table">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td>
                        <a target="_blank" href="{{ url('detail-jobs/'.$d->slug) }}">
                            <strong>{{ $d->title }}</strong>
                        </a>
                    </td>
                    <td>{{ $d->user->name }}</td>
                    <td>{{ is_numeric($d->jumlah) ? number_format((float)$d->jumlah, 0, ',', '.') : '-' }}</td>
                    <td>{{ is_numeric($d->komisi) ? number_format((float)$d->komisi, 0, ',', '.') : '-' }}</td>
                    <td>
