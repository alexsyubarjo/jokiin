    ...
    <div class="row">
        <div class="col-12 mb-4 order-0">
            ...
            <div class="card">
                ...
                <div id="data-tabel">
                    @include('admin.partial.data-repot')
                </div>
            </div>
                        ...
                        <div class="col mb-3">
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="data-repot-modal"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>\
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col mb-3">
                            ...
                            <form id="form-modal" action="{{ url('admin/data-repot/update-status') }}" method="post">
                                @csrf
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#data-repot', function() {
            var id = $(this).data('id');
            $.ajax({
                url: 'data-repot/modal-ajax',
                data: { id: id },
                success: function(data) {
                    $('#data-repot-modal').html(data.partialView);
                }
            });
        });
