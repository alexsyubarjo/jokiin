    ...
    <div class="row">
        <div class="col-12 mb-4 order-0">
            ...
            <div class="card">
                ...
                <div id="data-tabel">
                    @include('admin.partial.data-kategori')
                </div>
            </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form id="tambah-form-modal" action="{{ url('admin/data-kategori/store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-xl">
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <a href="https://v2.lineicons.com" target="_blank" type="button"
        ...
        <div class="modal fade" id="dataModal" aria-labelledby="dataModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="dataModalLabel">Edit Kategori</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">

                        <form id="form-modal" action="{{ url('admin/data-kategori/update') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-xl">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.dropdown-item#tombol-edit', function() {
            ...
            var uRL = '{{ route('get_data_kategori') }}';

            $.ajax({
                url: uRL,
                data: { id: id, },
                success: function(data) {
                    $('#id_data').val(data.kat.id);
                    $('#name').val(data.kat.name);
                    $('#slug').val(data.kat.slug);
                    $('#description').val(data.kat.description);
                    $('#icon').val(data.kat.icon);
                }
            });
        ...
        $(document).on('click', '#hapus', function() {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var id = $(this).data('id');
                    var url = '{{ url("admin/data-kategori/destroy") }}';
